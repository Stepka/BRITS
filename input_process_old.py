...
for filename in os.listdir(brits_path + 'raw'):
...
out = pd.read_csv(brits_path + 'raw/Outcomes-a.txt').set_index('RecordID')['In-hospital_death']
...
def parse_id(id_):
    data = pd.read_csv(brits_path + 'raw/{}.txt'.format(id_))
